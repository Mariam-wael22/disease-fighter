...
class Setting extends React.Component{
    ...
    render(){
        const {activef,avatarimg,name,old_password,new_password,about,location,phone,gender}=this.state;
        return(
                        ...
                        <div onClick={()=>this.setState({activef:false})}><p className={activef?(null):('active')}>Password & Security</p></div>
                            ...
                            {activef?(
                                <div className='main-setting col-lg-5 col-md-5'>
                                    ...
                                    <div className='update-img'>
                                        ...
                                        <img src={avatarimg} className='update-avatar' alt="avatar image" />
                            ...
                            <div className='d-flex justify-content-center align-items-center'>
                                ...
                                <div className='security-setting col-lg-5 col-md-5'>
                                    ...
                                    <div className='d-flex justify-content-center align-items-center'>
                                        <p className='btn active-btn' onClick={this.changepass}>Save Change</p>
                                    </div>
                                    </div>
                                </div>
                            )}
